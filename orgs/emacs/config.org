...
#+BEGIN_SRC emacs-lisp
   ...
   '(
    (c-c++ :variables 
     ...
     slack
     twitter
     (elfeed :variables rmh-elfeed-org-files (list "~/Dropbox/org/feed/emacs.org"
                                              ))
     (scala :variables 
...
#+BEGIN_SRC emacs-lisp
  ...
  (spacemacs/set-leader-keys "Bc" 'org-ref-clean-bibtex-entry)
#+END_SRC
*** DOI/PDF
#+BEGIN_SRC emacs-lisp
  ...
  (spacemacs/set-leader-keys "Bd" 'get-bibtex-from-doi)
  (defun paperdlr (doi) 
        "DOI paperdlr."
        (interactive "sDOI: ")
        (shell-command 
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-ref-open-pdf-function
        (lambda (fpath)
          (start-process "zathura" "*helm-bibtex-zathura*" "/usr/bin/zathura" fpath)))
  (spacemacs/set-leader-keys "Bh" 'helm-bibtex)
#+END_SRC
*** Search in PDFs
#+BEGIN_SRC emacs-lisp
