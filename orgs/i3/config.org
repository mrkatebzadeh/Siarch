...
client.focused          $red            $red        $magenta    $darkmagenta    $darkwhite
...
bar {
    ...
    colors {
            ...
            separator $cyan
            focused_workspace  $darkblack $darkblack $darkwhite
                active_workspace   $darkblack $darkblack $darkwhite
...
assign [class="Slack|slack"]               → 10
assign [class="Firefox|firefox"]           → 7
assign [class="Skype|skype|skypeforlinux"] → 9
#+END_SRC
